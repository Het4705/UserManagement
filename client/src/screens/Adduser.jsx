...
//         <span className="font-bold text-fuchsia-500">Add</span>{" "}
//         <span className="drop-shadow-xl font-bold fuchsia-500-shadow">
//           User
//         </span>
//       </h1>
...
//           <form
//             className="h-[95%] w-[95%] gap-2 flex flex-col justify-center items-center"
